...
// Image Assets
const playerImg = new Image(); playerImg.src = '/Jogador.png';
const gunImg = new Image(); gunImg.src = 'gun.png';
const gun2Img = new Image(); gun2Img.src = 'gun2.png';
const gun3Img = new Image(); gun3Img.src = 'gun3.png';
const enemyImg = new Image(); enemyImg.src = '/enemy (1).png';
const bossEnemyImg = new Image(); bossEnemyImg.src = '/bossenemy.png';
